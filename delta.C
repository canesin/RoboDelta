...
#include <math.h>
 ...
 // Constantes geométricas do rôbo
 // (Figuras no relatório)
 const float e = 30.0; // Lado do triangulo que circunscreve o manipulador
 const float f = 112.5; // Lado da do triangulo que circunscreve a base
 const float re = 232.0; // Braço ligado ao manipulador (e)
 const float rf = 112.0; // Braço ligado a base fixa
 
 // Constantes trigonométricas
 const float sqrt3 = sqrt(3.0);
 const float pi = 3.1415926535897931;    // PI constant value, from python
